    ...
    return (
      <div>
        ...
        <Grid style={{ paddingTop: '35px', paddingLeft: '70px', paddingRight: '70px' }} stackable columns={2}>
          ...
          the questions that drive me are at the intersection of technology and design -- whether I’m <a href="http://www.saimaakhtar.com/projects" >building</a> user-friendly applications
          or <a href="http://www.saimaakhtar.com/research" >writing</a> about the ethical implications of integrating technology into our everyday lives.
          <br />
            ...
            <br />
          I graduated with degrees in architecture from the <a href="https://ced.berkeley.edu/academics/architecture/programs/ph.d" target="_blank" rel="noopener noreferrer" >Center for Environmental Design at UC-Berkeley</a> (Ph.D.)
          and <a href="https://architecture.mit.edu/history-theory-and-criticism/degree/smarchs" target="_blank" rel="noopener noreferrer" >MIT</a> (SMArchS), and majored in psychology and architecture at the <a href="https://taubmancollege.umich.edu/architecture/degrees/bachelor-science" target="_blank" rel="noopener noreferrer" >University of Michigan - Ann Arbor</a>. I also completed a certificate in
          Fullstack engineering from the <a href="https://flatironschool.com/career-courses/coding-bootcamp" target="_blank" rel="noopener noreferrer" >Flatiron School</a>.
          <br />
            <br />
          I love building things and thinking, writing, and speaking about how technology impacts cities and society. If you'd like to work together or chat, please <a href="mailto:saimaakhtar@gmail.com">get in touch</a>!
          </Grid.Column>
        </Grid>
      </div>
    )
